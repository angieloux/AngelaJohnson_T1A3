...
- The user is welcomed to the store by a banner bearing the store name, AJ Records, as well as some introductory text. 
- They can decide whether they'd like to enter or not.
...
![Feature 2: Product Filter Search (Genre/Artist/Album/Price)](./docs/ProductFilterSearchAllOptions.gif "Feature 2: Product Filter Search (All Genre/Artist/Album/Price)")
...
#### *Go ahead and pay*
Will print cart summary in a table, and user can either select YES (to confirm, pay and exit) or NO (redirected to Store Navigation menu, as shown here:
...
![Feature 2: Product Filter Search Error Handling (Invalid Cat number)](./docs/ProductFilterSearchInvalidCatNumber.gif "Feature 2: Product Filter Search Error Handling (Invalid Cat number)")
...
![Feature 2: Product Filter Search Error Handling (Input not found)](./docs/ProductFilterSearchInvalidSearches.gif "Feature 2: Product Filter Search Error Handling (Input not found)")
...
![Feature 2: Product Filter Search Error Handling (Search is empty)](./docs/ProductFilterSearchEmptyString.gif "Feature 2: Product Filter Search Error Handling (Search is empty)")
...
![Feature 3: Cart Error Handling (Invalid input)](./docs/CartRemoveItemInvalidInput.gif "Feature 3: Cart Error Handling (Invalid input)")
